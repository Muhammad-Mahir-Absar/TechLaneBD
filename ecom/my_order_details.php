                                ...
                                <div class="wishlist-table table-responsive">
                                    <table>
                                        ...
                                        <tbody>
											...
											$res=mysqli_query($con,"select distinct(order_detail.id) ,order_detail.*,products.name,products.image from order_detail,products ,`order` where order_detail.order_id='$order_id' and `order`.user_id='$uid' and order_detail.product_id=products.id");
											$total_price=0;
